...
import 'package:loanapp/screens/loandetails.dart';
import 'package:loanapp/screens/profile.dart';
         ...
         Scaffold(
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                tabBar(iconz: Icons.group, textz: "profile"),
                tabBar(iconz: Icons.attach_money, textz: " loan "),
                tabBar(iconz: Icons.score, textz: " cibil score "),
              ],
            ),
          ),
          body: TabBarView(
